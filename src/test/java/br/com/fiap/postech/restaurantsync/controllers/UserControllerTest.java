...
public class UserControllerTest {
    ...
    /**
     ...
     @MockBean private FieldTranslationService translationService;
     ...
     @Test void testCreateUserBadRequest() throws Exception {
     mockMvc.perform(post("/v1/usuarios")
     .contentType(MediaType.APPLICATION_JSON)
     .content("{}"))
     ...
     @Test void testUpdatePasswordSuccess() throws Exception {
     Integer userId = 1;
